...
const PasswordModal: React.FC<PasswordModalProps> = ({ isVisible, onClose, onSave }) => {
        ...
        >
            <View style={styles.modalOverlay}>
                <View style={styles.modalContainer}>
                    <Text style={styles.modalTitle}>{t('childInformation.updatePassword')}</Text>
                    <View style={styles.passwordInputContainer}>
                        ...
                        <TouchableOpacity
                            ...
                            accessibilityLabel={isPasswordVisible ? t('childInformation.hidePassword') : t('childInformation.showPassword')}
                        >
                            <FontAwesomeIcon
