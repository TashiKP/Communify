...
interface ParentalControlsContextType extends ParentalSettings {
  updateSetting: <K extends keyof Omit<ParentalSettings, 'isInitialized'>>(
    key: K,
...
// --- Context ---
export const ParentalControlsContext =
  createContext<ParentalControlsContextType>({
    ...defaultSettings,
    updateSetting: () => {
      console.warn('ParentalControlsContext Provider not found');
    },
...
export const ParentalControlsProvider: React.FC<
  ParentalControlsProviderProps
> = ({children}) => {
  ...
  const updateSetting = useCallback(
    <K extends keyof Omit<ParentalSettings, 'isInitialized'>>(
      key: K,
      value: ParentalSettings[K],
    ) => {
  ...
  return (
    <ParentalControlsContext.Provider
      value={{...settings, updateSetting, saveAllSettings}}>
      {children}
    </ParentalControlsContext.Provider>
  );
};
