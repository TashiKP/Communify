  ...
  ({
    ...
    return (
      <LinearGradient
        colors={[
          theme.primary,
          theme.isDark ? theme.primaryMuted : theme.primary,
        ]}
        style={styles.bottomBarGradient}>
        <View style={styles.bottomBarContent}>
          <TouchableOpacity
            ...
            accessibilityLabel={t('bottomNav.search')}>
            <FontAwesomeIcon
              icon={faSearch}
              size={fonts.h1 * 0.9}
              color={theme.white}
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={openCustomPageModal}
            accessibilityLabel={t('bottomNav.addCustom')}>
            <FontAwesomeIcon
              icon={faPlus}
              size={fonts.h1 * 0.9}
              color={theme.white}
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={openKeyboardInput}
            accessibilityLabel={t('bottomNav.keyboard')}>
            <FontAwesomeIcon
              icon={faKeyboard}
              size={fonts.h1 * 0.9}
              color={theme.white}
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={openMenu}
            accessibilityLabel={t('bottomNav.settings')}>
            <FontAwesomeIcon
              icon={faCog}
              size={fonts.h1 * 0.9}
              color={theme.white}
