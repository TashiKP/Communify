...
const Navbar = () => {
    ...
    const { currentLanguage, changeLanguage, isTranslatingSymbols } = useLanguage(); // Use isTranslatingSymbols if needed, or remove if toggle shouldn't be disabled
    ...
    const sliderPosition = toggleAnim.interpolate({
        inputRange: [0, 1],
        outputRange: ['3%', '47%'], // Adjust based on toggle design
    });
            ...
            <View style={styles.navbar}>
                ...
                <View style={styles.navSectionLeft}>
                    <TouchableOpacity
                        ...
                        // disabled={isTranslatingSymbols} // Optional: Disable only if symbol batch translation is happening? Usually not needed for language toggle itself. Removed isTranslating.
                    >
