...
const BioCard: React.FC<BioCardProps> = ({ childData, onSave }) => {
    ...
    return (
        <Animated.View style={[styles.bioCard, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
            <LinearGradient
            ...
            {isEditing ? (
                <>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditedData({ ...editedData, user: { ...editedData.user, name: text } })}
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditedData({ ...editedData, user: { ...editedData.user, age: parseInt(text) || 0 } })}
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditedData({ ...editedData, user: { ...editedData.user, gender: text } })}
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setEditedData({ ...editedData, user: { ...editedData.user, email: text } })}
                ...
                <TouchableOpacity style={styles.editIconButton} onPress={() => setIsEditing(true)}>
                    <FontAwesomeIcon icon={faEdit} size={fonts.body * 1.1} color={theme.white} />
                </TouchableOpacity>
            )}
        </Animated.View>
    );
