...
import { faClosedCaptioning, faHighlighter } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <View style={styles.sectionCard}>
            <View style={styles.sectionHeader}>
                <FontAwesomeIcon icon={faClosedCaptioning} size={16 * 1.1} color={theme.primary} style={styles.sectionIcon} />
                <Text style={[styles.sectionTitle, { color: theme.text }]}>{t('voiceSettings.behaviorSectionTitle')}</Text>
            </View>
            <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                    <FontAwesomeIcon icon={faHighlighter} size={16 * 1.1} color={theme.textSecondary} style={styles.switchIcon} />
                ...
                <Switch
                    ...
                    accessibilityState={{ checked: settings.highlightWord, disabled: isSaving }}
                />
            </View>
            <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                    <FontAwesomeIcon icon={faClosedCaptioning} size={16 * 1.1} color={theme.textSecondary} style={styles.switchIcon} />
                ...
                <Switch
                    ...
                    accessibilityState={{ checked: settings.speakPunctuation, disabled: isSaving }}
                />
            </View>
