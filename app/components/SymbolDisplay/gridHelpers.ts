...
export const getNumColumns = (layout: GridLayoutType): number => {
  switch (layout) {
    ...
    case 'dense':
      return 8;
    default:
      return 6; // Default to standard if layout is somehow undefined or unexpected
  }
};
...
export const calculateItemWidth = (
  ...
  const availableWidthForItems =
    approxLeftPanelWidth -
    totalHorizontalGridPadding -
    totalHorizontalItemWrapperMargins;
  const minSizeBasedOnLayout =
    layout === 'simple' ? 90 : layout === 'standard' ? 75 : 60;
