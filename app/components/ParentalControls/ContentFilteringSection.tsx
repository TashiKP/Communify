...
const ContentFilteringSection: React.FC<ContentFilteringSectionProps> = ({
  ...
  const switchStyles = useMemo(
    () => ({
      ...
      thumbColor:
        Platform.OS === 'android' ? theme.primary || '#007aff' : undefined, // Added fallback
    ...
    <View style={[styles.defaultSectionCard, sectionStyle]}>
      ...
      <View style={[styles.defaultCardHeader, headerStyle]}>
        ...
        <Text style={[styles.defaultSectionTitle, titleStyle]}>
          {t('parentalControls.contentFiltering.sectionTitle')}
        </Text>
      </View>
      ...
      <View style={styles.settingRow}>
        ...
        <Switch
          ...
          accessibilityLabel={t(
            'parentalControls.contentFiltering.blockViolenceAccessibilityLabel',
          )}
      ...
      <View style={styles.settingRow}>
        ...
        <Switch
          ...
          {...switchStyles}
          accessibilityLabel={t(
            'parentalControls.contentFiltering.blockInappropriateAccessibilityLabel',
          )}
      ...
      <View style={styles.cardFooter}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
          accessibilityLabel={t(
            'parentalControls.contentFiltering.webFilteringAccessibilityLabel',
          )}
