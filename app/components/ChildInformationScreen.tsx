...
const ChildInformationScreen: React.FC<ChildInformationScreenProps> = ({
      ...
      <ScrollView
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.infoTitle}>
            {t('childInformation.personalInfo')}
          </Text>
          ...
          <View style={styles.infoRow}>
            <Text style={styles.infoLabel}>
              {t('childInformation.gender')}:
            </Text>
            <Text style={styles.infoValue}>
              {childData.user.gender
                ? capitalize(childData.user.gender)
                : 'N/A'}
            </Text>
          </View>
          <View style={styles.infoRow}>
        ...
        <View style={styles.sectionCard}>
          <TouchableOpacity
            ...
            <FontAwesomeIcon
              icon={
                expandedSection === 'personalInfo' ? faChevronUp : faChevronDown
              }
              size={fonts.body * 0.9}
              color={theme.text}
            />
        ...
        <View style={styles.sectionCard}>
          <TouchableOpacity
            ...
            <FontAwesomeIcon
              icon={
                expandedSection === 'childProfile' ? faChevronUp : faChevronDown
              }
              size={fonts.body * 0.9}
              color={theme.text}
            />
                ...
                <View
                  ...
                  <View style={{flex: 1}}>
                    ...
                    <Text
                      ...
                      {password
                        ? '********'
                        : t('childInformation.noPasswordSet')}
                    </Text>
                  </View>
                </View>
                <TouchableOpacity
