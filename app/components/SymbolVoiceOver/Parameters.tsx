...
import { faSlidersH, faLock, faLockOpen } from '@fortawesome/free-solid-svg-icons';
...
interface ParametersProps {
    ...
    onSettingChange: <K extends keyof VoiceSettingData>(key: K, value: VoiceSettingData[K]) => void;
    isSaving: boolean;
    sliderStyles: any;
    styles: any;
    theme: ThemeColors;
    ...
    return (
        <View style={styles.sectionCard}>
            <View style={styles.sectionHeader}>
                <FontAwesomeIcon icon={faSlidersH} size={16 * 1.1} color={theme.primary} style={styles.sectionIcon} />
            ...
            <View style={styles.settingItem}>
                ...
                <View style={styles.sliderControlRow}>
                    <TouchableOpacity
                        ...
                        onPress={() => onSettingChange('pitchLocked', !settings.pitchLocked)}
                        hitSlop={hitSlop}
                        accessibilityLabel={settings.pitchLocked ? t('voiceSettings.unlockPitch') : t('voiceSettings.lockPitch')}
                    ...
                    <Text
                        ...
                        accessibilityLabel={t('voiceSettings.pitchValueAccessibilityLabel', { value: formatValue(settings.pitch) })}
                    >
            ...
            <View style={styles.settingItem}>
                ...
                <View style={styles.sliderControlRow}>
                    <TouchableOpacity
                        style={styles.lockButton}
                        onPress={() => onSettingChange('speedLocked', !settings.speedLocked)}
                        hitSlop={hitSlop}
                        accessibilityLabel={settings.speedLocked ? t('voiceSettings.unlockSpeed') : t('voiceSettings.lockSpeed')}
                        accessibilityRole="button"
                        disabled={isSaving}
                    >
                        <FontAwesomeIcon
                    ...
                    <Text
                        style={[styles.valueText, { color: theme.primary }]}
                        accessibilityLabel={t('voiceSettings.speedValueAccessibilityLabel', { value: formatValue(settings.speed) })}
                    >
            ...
            <View style={styles.settingItem}>
                ...
                <View style={styles.sliderControlRow}>
                    <TouchableOpacity
                        style={styles.lockButton}
                        onPress={() => onSettingChange('volumeLocked', !settings.volumeLocked)}
                        hitSlop={hitSlop}
                        accessibilityLabel={settings.volumeLocked ? t('voiceSettings.unlockVolume') : t('voiceSettings.lockVolume')}
                        accessibilityRole="button"
                        disabled={isSaving}
                    >
                        <FontAwesomeIcon
                            ...
                            size={16 * 1.1}
                            color={settings.volumeLocked ? theme.primary : theme.textSecondary}
                        />
                    </TouchableOpacity>
                    <Slider
                        style={styles.slider}
                    ...
                    <Text
                        style={[styles.valueText, { color: theme.primary }]}
                        accessibilityLabel={t('voiceSettings.volumeValueAccessibilityLabel', { value: formatValue(settings.volume) })} // This line will now be correct
                    >
