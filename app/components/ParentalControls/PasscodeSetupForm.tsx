  ...
  return (
    <View style={styles.passcodeSetupCard}>
      <Text style={styles.passcodeSetupTitle}>
        {passcodeExists
          ? t('parentalControls.passcode.changeTitle')
          : t('parentalControls.passcode.setTitle')}
      </Text>
      {passcodeExists && (
        <View style={styles.inputGroup}>
          <Text style={styles.inputLabel}>
            {t('parentalControls.passcode.currentLabel')}
          </Text>
          <TextInput
      ...
      <View style={styles.inputGroup}>
        <Text style={styles.inputLabel}>
          {t('parentalControls.passcode.newLabel')}
        </Text>
        <TextInput
          ref={newPasscodeRef}
          style={styles.textInput}
      ...
      <View style={styles.inputGroup}>
        <Text style={styles.inputLabel}>
          {t('parentalControls.passcode.confirmLabel')}
        </Text>
        <TextInput
      ...
      {passcodeError && (
        <Text style={styles.passcodeFeedbackError}>{passcodeError}</Text>
      )}
      {passcodeSuccess && (
        <Text style={styles.passcodeFeedbackSuccess}>{passcodeSuccess}</Text>
      )}
