    ...
    return (
        <View style={styles.sectionCard}>
            <View style={styles.sectionHeader}>
                <FontAwesomeIcon icon={faPlayCircle} size={16 * 1.1} color={theme.primary} style={styles.sectionIcon} />
            ...
            >
                ...
                />
                <Text
                    style={[styles.previewButtonText, { color: isPreviewDisabled ? theme.textSecondary : theme.white }]}
                >
